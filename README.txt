...
По івенту в Компоненті дістаються дані з інпуту і задіспатчується в стору (dispatch - це метод стори)
як об'єк Екшена з типом і пейлоадом/даними:
...
Є редьюсер, що слухає dispatch івента.
